...
public class EmployeeDaoImpl implements EmployeeDao {
    ...
    private final static String INSERT = "INSERT INTO employees (first_name, last_name, age) VALUES (?, ?, ?)";
    private final static String UPDATE = "UPDATE employees SET first_name = ? , last_name = ? , age = ? WHERE id = ?";
    private final static String DELETE = "DELETE from employees WHERE id = ?";
    private final static String SELECT = "SELECT * FROM employees where id = ?";
